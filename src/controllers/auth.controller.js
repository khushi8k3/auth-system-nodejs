    ...
    return res
        ...
        .json(
            new ApiResponse(
                200,
                {user: createdUser},
                "User registerted successfully and verification email has been sent on your email"
            ),
        );
});
...
const refreshAccessToken = asyncHandler(async(req, res) => {
    ...
    if(!incomingRefreshToken){
        throw new ApiError(404, "Unauthorized acccess")
    }
    try {
...
const resetForgotPassword = asyncHandler(async(req, res) => {
    ...
    return res
        .status(200)
        .json(
            new ApiResponse(200, {}, "Password reset succesfully")
        )
});
